...
from collectors import system_stats, starlink_outage, interface_traffic, firewall_states, firewall_log, arp_hosts, netflow_clients, traffic_daily
...
def start_scheduler():
    ...
    _scheduler.add_job(starlink_outage.collect, "interval", seconds=60, id="starlink_outage")
